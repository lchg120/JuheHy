    ...
    u = function() {
        ...
        },
        {
            ...
            value: function(t) {
                ...
                if (this.position = this._prevPos = i, this._prevPosition = t, this._id && this._steps.length > 0) {
                    ...
                    for (var h = 0; h < a; h++) if ("action" == this._steps[h].type) 0 != e && (this._useTicks ? this._runAction(this._steps[h], i, i) : 1 == e && i < n ? (n != this.duration && this._runAction(this._steps[h], n, this.duration), this._runAction(this._steps[h], 0, i, !0)) : this._runAction(this._steps[h], n, i));
                    else if ("step" == this._steps[h].type) {
                        if (u == h) {
                            var p = this._steps[u];
        ...
        },
        {
            ...
            value: function(t, e, i) {
                ...
                n = i;
                e > i && (r = i, n = e);
                var a = t.t; (a == n || a > r && a < n || s && a == e) && t.f.apply(t.o, t.p)
            }
        },
        {
            key: "_addAction",
        ...
        },
        {
            ...
            value: function(t, e) {
                ...
                for (var o in this._initQueueProps) if (null == (n = i[o]) && (i[o] = n = this._initQueueProps[o]), null == (a = s[o]) && (s[o] = a = n), r = n == a || 0 == e || 1 == e || "number" != typeof n ? 1 == e ? a: n: n + (a - n) * e, this._page) {
        ...
        },
        {
            key: "_addTweenCall",
            value: function(t) {
                return t.d > 0 && (t.type = "tweenCall", this._steps.push(t), t.t = this.duration, this.duration += t.d),
                this
            }
        },
        {
        ...
        },
        {
            ...
            value: function(t) {
                ...
                return this._appendQueueProps(t),
                this._addAction({
                    f: this._set,
                    o: this,
                    p: [t, e || this._target]
        ...
        },
        {
            key: "to",
            value: function(t, e) {
                var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : void 0; (isNaN(e) || !e || e < 0) && (e = 0);
                var s = {
                    d: e || 0,
                ...
                return this._addStep(s),
                this.set(t)
            }
        },
        {
            key: "tweenCall",
            value: function(t, e) { (isNaN(e) || e < 0) && (e = 0);
                var i = {
                    d: e || 0,
                    tweenCall: t
                };
        ...
        },
        {
            key: "fastGet",
            value: function(t, e) {
                return e && u.removeTweens(t),
                new u(null, t, null, null)
            }
        },
        {
            key: "pageGet",
            value: function(t, e, i, s) {
                return s && u.removeTweens(t),
                new u(null, t, e, i)
            }
        },
        {
            ...
            value: function(t) {
                for (var e = s,
                i = e.length - 1; i >= 0; i--) e[i]._id == t && (e[i].paused = !0, e.splice(i, 1))
            }
        },
        {
            key: "_register",
            value: function(t, e) {
                ...
                var i = s;
                if (e) i.push(t),
                r || (n = Date.now(), setInterval(u._tick, 1e3 / 30), r = !0);
                else for (var a = i.length; a--;) if (i[a] == t) return void i.splice(a, 1)
            }
        },
        {
            key: "_tick",
            value: function() {
                ...
                p = void 0;
                try {
                    for (var v, d = o[Symbol.iterator](); ! (l = (v = d.next()).done); l = !0) {
                        var f = v.value;
